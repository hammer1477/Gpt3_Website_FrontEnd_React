...
const Features = () => {
  return (
    <div className='gpt3__features section__padding'id="feature">
      ...
      <Feature title="Message or am nothing" text="Led ask possible tricky relation elegance eat likewise debating. By message or am nothing amongst chiefly address."/>
      <Feature title="Really boy law county" text="Really boy law county she unable her sister. Feet you off its like like six. Among are leave law built now. In built table in an rapid blush."/>
      </div>
    </div>
  )
}
